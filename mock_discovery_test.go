...
func (_m *MockDiscovery) Address() string {
	ret := _m.Called()
...
func (_m *MockDiscovery) ConnectedNodes() []serf.Member {
	ret := _m.Called()
...
func (_m *MockDiscovery) Done() <-chan struct{} {
	ret := _m.Called()
...
func (_m *MockDiscovery) JoinNodes(nodes ...string) error {
...
func (_m *MockDiscovery) Name() string {
	ret := _m.Called()
...
func (_m *MockDiscovery) SendEvent(name string, payload []byte, params *serf.QueryParam) (*serf.QueryResponse, error) {
...
func (_m *MockDiscovery) SetTags(_a0 map[string]string) error {
	ret := _m.Called(_a0)
...
func (_m *MockDiscovery) Stop() error {
	ret := _m.Called()
...
func (_m *MockDiscovery) SubscribeToEvent(et serf.EventType, action func(serf.Event)) {
	_m.Called(et, action)
}

// Tags provides a mock function with given fields:
func (_m *MockDiscovery) Tags() map[string]string {
	ret := _m.Called()
