...
func (_m *MockNode) Apply(_a0 []byte, _a1 time.Duration) error {
...
func (_m *MockNode) Cluster() ([]*NodeInfo, error) {
	ret := _m.Called()
...
func (_m *MockNode) ConnectToNode(_a0 ...string) error {
...
func (_m *MockNode) Done() <-chan struct{} {
	ret := _m.Called()
...
func (_m *MockNode) IsLeader() bool {
	ret := _m.Called()
...
func (_m *MockNode) Leader() string {
	ret := _m.Called()
...
func (_m *MockNode) SendEvent(name string, payload []byte, params *serf.QueryParam) (EventResponse, error) {
...
func (_m *MockNode) SubscribeToEvent(queryName string, action func(*serf.Query)) {
	_m.Called(queryName, action)
}

// Tag provides a mock function with given fields: _a0
func (_m *MockNode) Tag(_a0 string) (string, bool) {
	ret := _m.Called(_a0)
