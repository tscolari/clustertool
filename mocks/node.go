...
func (_m *Node) SendEvent(name string, payload []byte, params *serf.QueryParam) (clustertool.EventResponse, error) {
...
func (_m *Node) SubscribeToEvent(queryName string, action func(*serf.Query)) {
