...
// MockHashicorpSerf is an autogenerated mock type for the HashicorpSerf type
type MockHashicorpSerf struct {
	mock.Mock
}

// Join provides a mock function with given fields: addresses, ignoreOld
func (_m *MockHashicorpSerf) Join(addresses []string, ignoreOld bool) (int, error) {
...
func (_m *MockHashicorpSerf) KeyManager() *serf.KeyManager {
	ret := _m.Called()
...
func (_m *MockHashicorpSerf) Leave() error {
	ret := _m.Called()
...
func (_m *MockHashicorpSerf) Members() []serf.Member {
	ret := _m.Called()
...
func (_m *MockHashicorpSerf) Query(name string, payload []byte, params *serf.QueryParam) (*serf.QueryResponse, error) {
...
func (_m *MockHashicorpSerf) SetTags(tags map[string]string) error {
	ret := _m.Called(tags)
...
func (_m *MockHashicorpSerf) Shutdown() error {
	ret := _m.Called()
...
// NewMockHashicorpSerf creates a new instance of MockHashicorpSerf. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewMockHashicorpSerf(t interface {
	mock.TestingT
	Cleanup(func())
}) *MockHashicorpSerf {
	mock := &MockHashicorpSerf{}
	mock.Mock.Test(t)
